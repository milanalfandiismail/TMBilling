                ...
                <tr class="hover:bg-[#121212] transition-colors block lg:table-row py-3 lg:py-0 border-b border-[#2a2a2a] last:border-b-0 lg:border-b-0">
                    <td class="px-3 lg:max-xl:px-4 xl:px-4 py-2 lg:max-xl:py-3 xl:py-2 text-left block lg:table-cell">
                        <div class="flex items-center gap-3">
                            <img src="${iconUrl}" alt="${g.nama}" class="w-9 h-9 lg:max-xl:w-10 lg:max-xl:h-10 xl:w-12 xl:h-12 rounded object-cover border border-[#262626] bg-[#1a1a1a]" onerror="this.onerror=null; this.src='${defaultIcon}'">
                            <div>
                                <div class="font-bold text-neutral-200 text-sm lg:max-xl:text-sm xl:text-base">${g.nama}</div>
                                <div class="text-[10px] lg:max-xl:text-xs xl:text-sm text-neutral-500 mt-0.5">${g.kategori || '-'}</div>
                            </div>
                        </div>
                    </td>
                    <td class="px-3 lg:max-xl:px-4 xl:px-4 py-2 lg:max-xl:py-3 xl:py-2 text-center flex lg:table-cell justify-between items-center border-t border-[#2a2a2a]/50 lg:border-t-0 mt-3 lg:mt-0 pt-3 lg:pt-0">
                        ...
                        <span class="font-bold text-xs lg:max-xl:text-xs xl:text-sm ${g.aktif ? 'text-green-500' : 'text-neutral-500'}">
                            ${g.aktif ? 'YA' : 'TIDAK'}
                        </span>
                    </td>
                    <td class="px-3 lg:max-xl:px-4 xl:px-4 py-2 lg:max-xl:py-3 xl:py-2 text-right flex lg:table-cell justify-between items-center">
                        ...
                        <div class="flex justify-end gap-1.5">
                            <button onclick="GameManagement.openEditModal(${JSON.stringify(g).replace(/"/g, '&quot;')})" class="w-7 h-7 lg:max-xl:w-7 lg:max-xl:h-7 xl:w-8 xl:h-8 rounded bg-[#171717] border border-[#262626] text-neutral-300 hover:bg-neutral-100 hover:text-black transition-colors" title="Edit">
                            ...
                            <button onclick="GameManagement.deleteGame(${g.id}, '${g.nama}')" class="w-7 h-7 lg:max-xl:w-7 lg:max-xl:h-7 xl:w-8 xl:h-8 rounded bg-[#171717] border border-[#262626] text-red-400 hover:bg-red-600 hover:text-white transition-colors" title="Hapus">
