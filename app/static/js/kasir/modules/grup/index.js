const Grup = {
            ...
            <div class="bg-[#111] border border-[#2a2a2a] rounded-xl p-6 max-w-md w-[calc(100%-2rem)] mx-auto md:w-full shadow-2xl">
                <div class="flex items-center justify-between mb-5 pb-4 border-b border-[#2a2a2a]">
                    <div>
                        ...
                        <p class="text-[10px] text-neutral-500 mt-0.5">Buat zona / kelompok PC baru</p>
                    </div>
                ...
                <div class="space-y-4">
                    <div>
                        <label class="text-[9px] text-neutral-500 mb-1.5 block uppercase font-bold tracking-wider">Nama Grup <span class="text-red-400">*</span></label>
                        <input type="text" id="modal-grup-nama" placeholder="Nama Grup" class="w-full px-3 py-2.5 bg-[#0a0a0a] border border-[#2a2a2a] rounded-lg text-xs text-neutral-200 placeholder-neutral-600 focus:outline-none focus:border-neutral-500 transition-colors">
                    </div>
                    <div>
                        <label class="text-[9px] text-neutral-500 mb-1.5 block uppercase font-bold tracking-wider">Keterangan</label>
                        <input type="text" id="modal-grup-ket" placeholder="Deskripsi grup (opsional)" class="w-full px-3 py-2.5 bg-[#0a0a0a] border border-[#2a2a2a] rounded-lg text-xs text-neutral-200 placeholder-neutral-600 focus:outline-none focus:border-neutral-500 transition-colors">
                    </div>
                    <div>
                        <label class="text-[9px] text-neutral-500 mb-1.5 block uppercase font-bold tracking-wider">Warna Grup</label>
                        <div class="flex items-center gap-3 px-4 py-2.5 bg-[#0a0a0a] border border-[#2a2a2a] rounded-lg">
                            ...
                            <span class="text-[10px] text-neutral-500">Warna aksen untuk lencana grup ini</span>
                        </div>
                    </div>
                </div>
                <div class="flex gap-3 justify-end mt-6 pt-4 border-t border-[#2a2a2a]">
                    ...
                    <button onclick="Grup.add()" class="px-5 py-2.5 bg-neutral-100 hover:bg-white text-black text-xs font-bold rounded-lg transition-colors flex items-center gap-2">
    ...
    async delete(id, nama) {
        const message = `<div class="text-center"><p class="text-xs text-neutral-400">Hapus grup <span class="text-neutral-200 font-bold uppercase">${nama}</span>? Pastikan tidak ada PC atau Paket yang terikat.</p></div>`;
        ...
        if (list.length === 0) {
            area.innerHTML = `
                <div class="flex flex-col items-center justify-center py-20 text-neutral-500 bg-[#0c0c0c] border border-dashed border-[#1c1c1c] rounded">
                    ...
                    <p class="text-xs font-bold uppercase tracking-wider">Belum Ada Grup</p>
                </div>`;
            return;
        }
                        ...
                        ${list.map(g => `
                            <tr class="hover:bg-[#121212] transition-colors block lg:table-row py-3 lg:py-0 border-b border-[#2a2a2a] last:border-b-0 lg:border-b-0">
                                <td class="px-6 py-4 flex lg:table-cell justify-between items-center">
                                    <span class="text-[10px] text-neutral-500 font-bold uppercase tracking-wider lg:hidden">ID</span>
                                ...
                                <td class="px-6 py-4 flex lg:table-cell justify-between items-center border-t border-[#2a2a2a]/50 lg:border-t-0">
                                    <span class="text-[10px] text-neutral-500 font-bold uppercase tracking-wider lg:hidden">Nama Grup</span>
                                    <span class="px-2.5 py-0.5 rounded text-[10px] font-bold uppercase" style="background-color: ${g.warna}15; color: ${g.warna}; border: 1px solid ${g.warna}25;">${g.nama}</span>
                                </td>
                                <td class="px-6 py-4 flex lg:table-cell justify-between items-center">
                                    <span class="text-[10px] text-neutral-500 font-bold uppercase tracking-wider lg:hidden">Keterangan</span>
