            ...
            html += `
                <div class="mb-8 last:mb-0">
                    <div class="flex items-center gap-3 mb-4 pb-3 border-b border-neutral-800">
                        ...
                        <span class="text-[10px] lg:text-base text-neutral-400 bg-neutral-800 border border-neutral-700 px-2.5 py-0.5 rounded font-bold">${list.length} Paket</span>
                    </div>
                    <div class="overflow-x-hidden w-full">
                        <table class="w-full text-xs lg:text-base block lg:table">
                            <thead class="hidden lg:table-header-group">
                                <tr class="text-[9px] lg:text-base text-neutral-500 uppercase tracking-wider border-b border-neutral-800">
                            ...
                            <tbody class="divide-y divide-[#2a2a2a] lg:divide-[#1c1c1c] block lg:table-row-group">
                                ${list.map(p => `
                                    <tr class="hover:bg-neutral-800 transition-colors block lg:table-row py-3 lg:py-0 border-b border-neutral-700 last:border-b-0 lg:border-b-0">
                                        ...
                                        <td class="px-4 py-2 text-center font-mono flex lg:table-cell justify-between items-center border-t border-neutral-700/50 lg:border-t-0">
                                        ...
                                        <td class="px-4 py-2 text-right flex lg:table-cell justify-between items-center">
                                            ...
                                            <div class="flex justify-end gap-1.5">
                                                ...
                                                <button onclick="Paket.edit(${p.id})" class="w-8 h-8 rounded bg-neutral-800 border border-neutral-700 text-neutral-300 hover:bg-neutral-100 hover:text-black transition-colors" title="Edit">
                                                ...
                                                <button onclick="Paket.delete(${p.id})" class="w-8 h-8 rounded bg-neutral-800 border border-neutral-700 text-red-400 hover:bg-red-600 hover:text-white transition-colors" title="Hapus">
