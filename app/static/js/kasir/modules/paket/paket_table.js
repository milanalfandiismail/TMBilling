                    ...
                    <div class="overflow-x-auto w-full">
                        <table class="w-full text-xs lg:max-xl:text-xs xl:text-base block lg:table">
                            <thead class="hidden lg:table-header-group">
                                <tr class="text-[9px] lg:max-xl:text-xs xl:text-base text-neutral-500 uppercase tracking-wider border-b border-[#1c1c1c]">
                                    <th class="px-3 lg:max-xl:px-3 xl:px-4 py-2 text-left w-[45%] md:w-[35%] font-bold">Nama</th>
                            ...
                            <tbody class="divide-y divide-[#2a2a2a] lg:divide-[#1c1c1c] block lg:table-row-group">
                                ${list.map(p => `
                                    <tr class="hover:bg-[#121212] transition-colors block lg:table-row py-3 lg:py-0 border-b border-[#2a2a2a] last:border-b-0 lg:border-b-0">
                                        ...
                                        <td class="px-3 lg:max-xl:px-3 xl:px-4 py-2 text-center font-mono flex lg:table-cell justify-between items-center border-t border-[#2a2a2a]/50 lg:border-t-0">
                                            <span class="text-[10px] lg:max-xl:text-xs xl:text-base text-neutral-500 font-bold uppercase tracking-wider lg:hidden">Durasi</span>
                                        ...
                                        <td class="px-3 lg:max-xl:px-3 xl:px-4 py-2 text-center font-mono flex lg:table-cell justify-between items-center">
                                            <span class="text-[10px] lg:max-xl:text-xs xl:text-base text-neutral-500 font-bold uppercase tracking-wider lg:hidden">Harga</span>
                                        ...
                                        <td class="px-3 lg:max-xl:px-3 xl:px-4 py-2 text-right flex lg:table-cell justify-between items-center">
                                            ...
                                            <div class="flex justify-end gap-1.5">
                                                ...
                                                <button onclick="Paket.delete(${p.id})" class="w-8 h-8 lg:max-xl:w-7 lg:max-xl:h-7 xl:w-8 xl:h-8 rounded bg-[#171717] border border-[#262626] text-red-400 hover:bg-red-600 hover:text-white transition-colors" title="Hapus">
