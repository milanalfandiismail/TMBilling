            ...
            return `
                <div class="screenshot-card h-full bg-[#121212] border border-[#1c1c1c] rounded overflow-hidden flex flex-col justify-between" data-pcid="${pc.pc_id}">
                    <div class="flex-1 flex flex-col">
                        ...
                        <div class="relative flex-1 aspect-video w-full bg-black flex items-center justify-center group cursor-pointer" onclick="Screenshot.openLightbox('${hasImage ? pc.screenshot_url : ''}', '${pc.pc_kode}')">
                        ${hasImage 
