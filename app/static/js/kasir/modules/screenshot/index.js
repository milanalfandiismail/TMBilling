const Screenshot = {
    ...
    renderGrid() {
        ...
        container.innerHTML = data.map(pc => {
            ...
            return `
                <div class="screenshot-card h-full flex flex-col bg-[#121212] border border-[#1c1c1c] rounded overflow-hidden" data-pcid="${pc.pc_id}">
                    ...
                    <div class="mt-auto p-3 text-sm text-neutral-400 flex justify-between items-center bg-[#0c0c0c] border-t border-[#1c1c1c]">
                        <span>Update:</span>
