            ...
            html += `
                <div class="mb-8 last:mb-0">
                    <div class="flex items-center gap-3 mb-4 pb-3 border-b border-[#1c1c1c]">
                        ...
                        <span class="text-[10px] lg:text-base text-neutral-400 bg-[#171717] border border-[#262626] px-2 py-0.5 rounded font-bold">${pcs.length} UNIT</span>
                    </div>
                        ...
                        ${pcs.map(pc => {
                            ...
                            return `
                                <div class="bg-[#0c0c0c] border ${pc.aktif ? 'border-[#262626]' : 'border-[#1c1c1c] opacity-50'} rounded p-3 transition-colors hover:bg-[#121212] relative group">
                                    ...
                                    <span class="text-[9px] lg:text-base text-neutral-400 bg-[#171717] border border-[#262626] px-1.5 py-0.5 rounded font-bold">${pcGrupNama.toUpperCase()}</span>
                                    <div class="absolute inset-0 bg-[#0c0c0c]/95 rounded flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        ...
                                        <button onclick="PC.edit(${pc.id})" class="w-8 h-8 rounded bg-[#171717] border border-[#262626] text-neutral-300 hover:bg-neutral-100 hover:text-black transition-colors flex items-center justify-center" title="Edit PC">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                        </button>
                                        <button onclick="PC.delete(${pc.id})" class="w-8 h-8 rounded bg-[#171717] border border-[#262626] text-red-400 hover:bg-red-600 hover:text-white transition-colors flex items-center justify-center" title="Hapus PC">
